...
export default {
  ...
  tags: ["#ux", "#thinking"],
  title: { en: "It depends", vi: "Còn tùy" },
  slug: "it-depends",
  pagesEn: [],
  pagesVi: [
    <>
    ...
    <>
      <P>
        ...
        trên thế giới có vận tốc khoảng 16km/h, bây giờ thì chiếc xe máy vớ vẩn
        vít ga cũng phải gấp đôi ngần đó, còn{" "}
        <a
          href="https://zingnews.vn/10-mau-moto-nhanh-nhat-the-gioi-toc-do-toi-da-560-kmh-post974537.html"
          target={"_blank"}
        >
          xe máy nhanh nhất
        </a>{" "}
